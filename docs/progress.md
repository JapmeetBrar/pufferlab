...
| M2-B | [SQLite persistence and run lifecycle](milestone-2-execution.md#m2-b--sqlite-persistence-and-run-lifecycle) | persistence_worker | `codex/m2-persistence-jobs` / PR pending | implementing | Branch `codex/m2-persistence-jobs` is based on reviewed M2-0 merge `42c3da5`; implement immutable revisions, incremental outcomes, recovery, cancellation, and migration coverage within the persistence/jobs boundary. |
