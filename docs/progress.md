...
| M1-F | [Live vertical-slice verification](live-verification.md) | root + reviewer | `codex/m1-live-verification` | implementing | The locked optional runtime and exact pinned BGE revision loaded successfully without credentials; real query/passage embeddings were finite, 384-dimensional, and unit-normalized, and 16 focused CLI/embedding tests passed. Credentialed provider, ingestion/rerun, browser, cleanup, final review, and protected merge evidence remain pending. |
