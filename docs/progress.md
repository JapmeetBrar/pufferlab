...
| M2-0 | [Milestone 2 coordination and contract audit](milestone-2-execution.md#m2-0--coordination-and-contract-audit) | root | `codex/m2-plan` / [PR #10](https://github.com/JapmeetBrar/pufferlab/pull/10) | implementing | [Review at `008d684`](https://github.com/JapmeetBrar/pufferlab/pull/10#issuecomment-5383830840) accepted the technical graph but blocked merge on an under-specified CQADupStack source/license/artifact boundary. Repair now pins the BEIR and CQADupStack revisions, archive URL/MD5 plus required SHA-256 lock, Apache-versus-CC license chain, retained attribution fields, NOTICE audit, and exact tracked/ignored inventory before re-review. |
