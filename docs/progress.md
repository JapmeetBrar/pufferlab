...
| M2-0 | [Milestone 2 coordination and contract audit](milestone-2-execution.md#m2-0--coordination-and-contract-audit) | root | `codex/m2-plan` / [PR #10](https://github.com/JapmeetBrar/pufferlab/pull/10) | verified | Dedicated re-review approved repair head `811febf`; PR #10 merged to protected `main` as `42c3da5`, and post-merge Backend and Frontend checks passed. |
...
| M2-D | [CQADupStack Unix dataset foundation](milestone-2-execution.md#m2-d--cqadupstack-unix-dataset-foundation) | dataset_worker | `codex/m2-unix-dataset` / PR pending | implementing | Assigned from reviewed M2-0 merge `42c3da5`; implement pinned fail-closed acquisition, deterministic attributed processing/qrels/ID-only curation, exposure audits, and resumable no-delete ingestion. |
...
| 2026-08-22 | M2-0 / [PR #10](https://github.com/JapmeetBrar/pufferlab/pull/10) | `review_requested → approved → merged → verified` | Dedicated re-review approved repair head `811febf`; PR #10 merged as `42c3da5`, and protected `main` Backend and Frontend checks passed. |
| 2026-08-22 | M2-D | `planned → assigned → implementing` | Dataset worker branched `codex/m2-unix-dataset` from reviewed M2-0 merge `42c3da5`. Work is confined to deterministic dataset adapter/manifests, attribution/audit documentation, dataset tests, and resumable ingestion service extensions; real licensed text and the 5.34 GB archive remain local and ignored. |
